...
```mermaid
graph LR
A[People & Family] --> B[Animals & Nature]
B --> C[Food & Drink]
C --> D[Environment & Weather]
D --> E[Activities / Sports]
E --> F[Objects / Tools]
F --> G[Flags]
```
...
![Markdown](https://img.shields.io/badge/Markdown-Guide-blue)
![Emojis](https://img.shields.io/badge/Emojis-CheatSheet-orange)
